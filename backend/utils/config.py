...
class Config:
    ...
    DATABASE_PATH = os.path.join(
        os.path.dirname(__file__), "..", "..", "database", "stock_market.db"
    )
    ...
    IEX_API_KEY = os.getenv(
        "IEX_API_KEY", "Optional: Not needed if using Yahoo Finance"
    )
    ...
    def validate_config():
        ...
        required_keys = ["ALPHA_VANTAGE_API_KEY", "NEWS_API_KEY"]
